/**
 * API Route: GET /api/reports/refunds
 *
 * Retorna lista de refunds com notas estruturadas
...
export async function GET(request: NextRequest) {
  try {
    ...
    const filterOptions = await getFilterOptions('refund');
    ...
    console.error('Unexpected error in /api/reports/refunds:', error);
    return NextResponse.json(
