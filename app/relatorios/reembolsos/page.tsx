...
export default function RefundsReportPage() {
  ...
  const { data, error, isLoading } = useSWR(
    `/api/reports/refunds?${buildQueryString()}`,
    fetcher,
    { refreshInterval: 0 }
  );
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-blue-900/20 to-gray-900 p-8">
      <div className="max-w-7xl mx-auto">
        {/* Header */}
        <div className="mb-8">
          <h1 className="text-4xl font-bold text-white mb-2">Relatório de Reembolsos</h1>
          <p className="text-gray-400">
            Análise detalhada de reembolsos com notas estruturadas
          </p>
        </div>
        ...
        {/* Table */}
        <ReportTable data={data?.data || []} tipo="refund" loading={isLoading} />
